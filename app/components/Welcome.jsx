  ...
  render(){
    return(
      <div>
        ...
        <a href="http://chicagotechslack.com">Chicago Tech Slack</a> in the #nodejs and #javascript channels</p>
        <p>Source for this page is available in our 
        <a href="https://github.com/ChicagoJS">Github Organization</a>. PR's always welcome.</p>
      </div>
    )
  }
}